...
#+RESULTS:
| (lambda nil (setq-default dired-omit-files-p t) (dired-omit-mode 1)) | (lambda nil (setq-default dired-omit-files-p t) (setq dired-omit-files (concat dired-omit-files \ | ^\..+$)) (dired-omit-mode 1)) | (lambda nil (dired-omit-mode 1)) | dired-extra-startup | (lambda nil (dired-hide-details-mode)) | (lambda nil) |
...
** Hydras
 ...
 #+BEGIN_SRC emacs-lisp
   ...
   (defhydra aj/hydra-shell (:color blue)
   "
   ...
   "
     ...
     ;; Note that these are org-mode specific!!
     (define-key org-mode-map (kbd "C-c h") 'aj/hydra-shell/body)
     ;; h for hydra!!
   ;;(hydra-set-property 'hydra-shell :verbosity 1)
