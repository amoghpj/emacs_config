...
(use-package projectile
  ...
  (setq projectile-project-search-path '("~/jalihal_projects/Research/data/ModelAnalysis/" "~/group/amogh-jalihal/" "~/orgs/"))
#+end_src

#+RESULTS:
| ~/jalihal_projects/Research/data/ModelAnalysis/ | ~/group/amogh-jalihal/ | ~/orgs/ |
* Nswbuff
